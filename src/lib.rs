// src/lib.rs
/*
 * Core library for MultiCallAggregator
 */
...
#[derive(Debug)]
pub struct MultiCallAggregatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MultiCallAggregatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MultiCallAggregator processing");
    
    let mut processor = MultiCallAggregatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MultiCallAggregatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MultiCallAggregatorProcessor::new(false);
